...
//not sure if this is right.... it's probably not
...
let friendsAndFamily = ["Caleb", "Junne", "Zac", "Jalynn", "Nelson"]
...
let sortedCollection2 = friendsAndFamily.sorted { (name1: String, name2: String) -> Bool in
    return name1 < name2
}
