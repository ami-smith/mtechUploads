...
class AddRegistrationTableViewController: UITableViewController, SelectRoomTypeTableViewControllerDelegate {
    ...
    @IBOutlet weak var numberOfNightsCount: UILabel!
    @IBOutlet weak var numberOfNightsDates: UILabel!
    @IBOutlet weak var roomTypeCost: UILabel!
    @IBOutlet weak var roomTypeCostBreakdown: UILabel!
    @IBOutlet weak var wifiTotal: UILabel!
    @IBOutlet weak var wifiSelection: UILabel!
