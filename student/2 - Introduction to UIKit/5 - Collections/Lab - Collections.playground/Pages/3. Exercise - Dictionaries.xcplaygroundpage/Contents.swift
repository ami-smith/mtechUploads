...
if let day = daysInMonth["January"] {
    print("January has \(day) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["Square", "Circle", "Triangle"]
var colorsArray = ["Blue", "Green", "Purple"]

var dictionary = ["Shapes": shapesArray, "Colors": colorsArray]

print(dictionary)
//not sure if this is the right order when printed... I definitely googled this and don't 100% understand it but it works lol
...
if let lastElement = dictionary["Colors"]?.last {
    print(lastElement)
}
