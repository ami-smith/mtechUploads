 ...
 */
var walkingChallenge = ["Walk 3 miles a day", "Walk for 30 minutes"]

var runningChallenge = ["Run 3 times a week", "Run for 20 minutes"]
...
let array1 = walkingChallenge
let array2 = runningChallenge
var containerArray = [array1, array2]
let firstArray = containerArray[0]
let firstElement = containerArray[0][0]
print(containerArray[1][0])

//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
print(containerArray.removeAll())
//******* do I need to have a variable called challenges???**********
