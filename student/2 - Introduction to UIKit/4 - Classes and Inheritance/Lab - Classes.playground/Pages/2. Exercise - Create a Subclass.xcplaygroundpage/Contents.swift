...
//print(falcon.weapon)
//This doesn't work because falcon is not in our scope. We created a whole new individual sub class and falcon is a completely different entity than what we're working on now, which is the destroyer object.
