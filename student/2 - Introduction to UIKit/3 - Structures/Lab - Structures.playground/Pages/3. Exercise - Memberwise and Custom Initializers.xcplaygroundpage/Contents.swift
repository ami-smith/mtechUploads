...
let favoriteBook = Book(title: "Harry Potter", author: "J.K. Rowling", pages: 500, price: 30.00)
print(favoriteBook.title)
print(favoriteBook.author)
print(favoriteBook.pages)
print(favoriteBook.price)
print("My favorite book is \(favoriteBook.title) and it has \(favoriteBook.pages) pages.")
/*:
...
struct Laptop {
    ...
    var yearPurchased: Int = 13
}
let laptop1 = Laptop(screenSize: 14)
let laptop2 = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 11)
