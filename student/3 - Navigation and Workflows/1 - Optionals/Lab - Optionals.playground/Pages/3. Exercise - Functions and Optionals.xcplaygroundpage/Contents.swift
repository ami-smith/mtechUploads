...
func inventoryChecker(key: String) -> Double? {
    if let stock = stock[key] {
        if stock > 0 {
...
inventoryChecker(key: "Chips")
inventoryChecker(key: "Donuts")
inventoryChecker(key: "Juice")
inventoryChecker(key: "Broccoli")
/*:
