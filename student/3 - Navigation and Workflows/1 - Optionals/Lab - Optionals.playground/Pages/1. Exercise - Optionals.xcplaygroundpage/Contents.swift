...
print("because '34e' cannot be converted to a number because the initializer is returning nil")
 ...
 */
//it seems off because it says "Optional" in the printed answer. To force unwrap, add ! to the end
print(userAge!)

//:  Now use optional binding to unwrap `userAge`. If `userAge` has a value, print it to the console.
if let userAgeNew = userAge {
    print("My age is \(userAgeNew).")
}
